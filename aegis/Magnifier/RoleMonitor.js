...
*/
	...
	var loadRoleListWin = function() {
		...
		fieldSet.append ("<label for='magFactor'>Magnification factor (%) <input id='magFactor' name='magFactor' value='150' size='6'></label><br>");
		...
		table.css ("font-size", "95%");
		table.append ("<tr><th> </th><th>Size (%):</th><th>Colour:</th><th>Background:</th></tr>");
		table.append ("<tr><td><input id='menu' type='checkbox'><label for='menu'>Menus:</label></td><td><input id='menuMagFactor' name='menuMagFactor' value='200' size='6'></td><td><input id='menuColour' name='menuColour' value='blue' size='6''></td><td><input id='menuBgColour' name='menuBgColour' value='yellow' size='6'></td></tr>");
		table.append ("<tr><td><input id='toolbar' type='checkbox'><label for='toolbar'>Toolbar:</label></td><td><input id='toolbarMagFactor' name='toolbarMagFactor' value='400' size='6'></td><td><input id='toolbarColour' name='toolbarColour' value='black' size='6''></td><td><input id='toolbarBgColour' name='toolbarBgColour' value='#00eeff' size='6'></td></tr>");
		table.append ("<tr><td><input id='checkbox' type='checkbox'><label for='checkbox'>Checkbox:</td><td><input id='checkboxMagFactor' name='checkboxMagFactor' value='500' size='6'></td><td><input id='checkboxColour' name='checkboxColour' value='white' size='6''></td><td><input id='checkboxBgColour' name='checkboxBgColour' value='black' size='6'></td></tr>");
		table.append ("<tr><td>Edit Pane:</td><td><input id='textboxMagFactor' name='textboxMagFactor' value='200' size='6'></td><td><input id='textboxColour' name='textboxColour' value='yellow' size='6''></td><td><input id='textboxBgColour' name='textboxBgColour' value='black' size='6'></td></tr>");
	...
	aegis.atrc.showRolesWindow = function() {
		...
		// <div> element.
		jQuery ("div#mainContent").css ({left: "auto%", right: "auto", marginLeft: "39%", width: "62%", overflow: "auto"});
