...
*/
	...
	var loadRoleListWin = function() {
		...
		table.append ("<tr><td><input id='menu' type='checkbox'><label for='menu'>Menus:</label></td><td><input id='menuMagFactor' name='menuMagFactor' value='200' size='8'></td><td><input id='menuColour' name='menuColour' value='blue' size='9''></td><td><input id='menuBgColour' name='menuBgColour' value='yellow' size='9'></td></tr>");
		table.append ("<tr><td><input id='toolbar' type='checkbox'><label for='toolbar'>Toolbar:</label></td><td><input id='toolbarMagFactor' name='toolbarMagFactor' value='400' size='8'></td><td><input id='toolbarColour' name='toolbarColour' value='black' size='9''></td><td><input id='toolbarBgColour' name='toolbarBgColour' value='#00eeff' size='9'></td></tr>");
		table.append ("<tr><td><input id='checkbox' type='checkbox'><label for='checkbox'>Checkbox:</td><td><input id='checkboxMagFactor' name='checkboxMagFactor' value='500' size='8'></td><td><input id='checkboxColour' name='checkboxColour' value='white' size='9''></td><td><input id='checkboxBgColour' name='checkboxBgColour' value='black' size='9'></td></tr>");
