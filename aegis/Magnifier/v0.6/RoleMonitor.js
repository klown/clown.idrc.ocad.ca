...
*/
	...
	var handleInputStyleChanges = function (evt) {
		...
		if (givenId) {
			...
			if ((givenId == "textbox") || (!theFollowFocus.attr ("checked"))) {
	...
	// Clear all magnified roles, except the text box.
	//
	var resetAllRoleElements = function() {
		jQuery.each (aegis.atrc.theOrigRoleStyles, function (idx) {
			var aPrevStyles = aegis.atrc.theOrigRoleStyles[idx];
			if (aPrevStyles.jRoleEl.attr ("role") != "textbox") {
				aegis.atrc.magnifyEl (aPrevStyles, 100);
			}			
		});
	
	};	// end resetAllRoleElements
	...
	var loadRoleListWin = function() {
		...
		table.append ("<tr><td>Menus:</td><td><input id='menuMagFactor' name='menuMagFactor' value='200' size='8'></td><td><input id='menuColour' name='menuColour' value='blue' size='9''></td><td><input id='menuBgColour' name='menuBgColour' value='yellow' size='9'></td></tr>");
		table.append ("<tr><td>Toolbar:</td><td><input id='toolbarMagFactor' name='toolbarMagFactor' value='400' size='8'></td><td><input id='toolbarColour' name='toolbarColour' value='black' size='9''></td><td><input id='toolbarBgColour' name='toolbarBgColour' value='#00eeff' size='9'></td></tr>");
		table.append ("<tr><td>Checkbox:</td><td><input id='checkboxMagFactor' name='checkboxMagFactor' value='500' size='8'></td><td><input id='checkboxColour' name='checkboxColour' value='white' size='9''></td><td><input id='checkboxBgColour' name='checkboxBgColour' value='black' size='9'></td></tr>");
		table.append ("<tr><td>Edit Pane:</td><td><input id='textboxMagFactor' name='textboxMagFactor' value='200' size='8'></td><td><input id='textboxColour' name='textboxColour' value='yellow' size='9''></td><td><input id='textboxBgColour' name='textboxBgColour' value='black' size='9'></td></tr>");
...
/*		
		...
		fieldSet.append ("<label for='magByOverlay'><input id='magByOverlay' type='checkbox' name='magByOverlay'>Overlay magnification</label><br>");
