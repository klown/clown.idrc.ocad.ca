  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>156/172</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-yes">1883x</span>
<span class="cline-any cline-yes">1907x</span>
...
<span class="cline-any cline-yes">1103x</span>
<span class="cline-any cline-yes">1103x</span>
<span class="cline-any cline-yes">5661x</span>
<span class="cline-any cline-yes">5661x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1103x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-yes">794x</span>
<span class="cline-any cline-yes">794x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
gpii.invokeLater = function (callback, time) {
    ...
    return time ? setTimeout(wrapped, time) : <span class="branch-1 cbranch-no" title="branch not covered" >fluid.invokeLater(wrapped);</span>
};
&nbsp;
...
gpii.resolveSync = function (response) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (fluid.isPromise(response)) {
...
gpii.settingsHandlers.comparePayloads = function (payload1, payload2) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!equal) {
...
gpii.settingsHandlers.checkRereadSettings = function (that) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (that.retryOptions.rewriteEvery &amp;&amp; !fluid.resolveContext("gpii.contexts.test", that)) {
<span class="cstat-no" title="statement not covered" >        fluid.fail("rewriteEvery is set to " + that.retryOptions.rewriteEvery</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (writeAttempt) {
<span class="cstat-no" title="statement not covered" >        fluid.log(fluid.logLevel.WARN,</span>
    ...
    var response = gpii.resolveSync(fluid.invokeGlobalFunction(that.resolvedName + (writeAttempt ? <span class="branch-0 cbranch-no" title="branch not covered" >".set" </span>: ".get"), [that.payload]));
    var getResponse = writeAttempt ? <span class="branch-0 cbranch-no" title="branch not covered" >gpii.settingsHandlers.setResponseToSnapshot(response) </span>: response;
    var equal = gpii.settingsHandlers.comparePayloads(getResponse, that.payload);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (equal) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (currentSettings !== holder.model) {
...
gpii.settingsHandlers.readFile = function (options) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!options || !options.filename) {
...
gpii.settingsHandlers.handleFileSolutionEntry = function (solutionEntry, modifier, parser, isWrite) {
    var options = solutionEntry.options;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options &amp;&amp; (options.path || options.filename)) {
