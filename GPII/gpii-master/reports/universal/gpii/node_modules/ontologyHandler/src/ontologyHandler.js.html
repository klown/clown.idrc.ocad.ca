...
<html lang="en">
<head>
    <title>Code coverage report for universal/gpii/node_modules/ontologyHandler/src/ontologyHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">universal/gpii/node_modules/ontologyHandler/src</a> ontologyHandler.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">99.49% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>197/198</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-yes">240x</span>
<span class="cline-any cline-yes">966x</span>
<span class="cline-any cline-yes">3894x</span>
<span class="cline-any cline-yes">15726x</span>
...
&nbsp;
        var toFrom = to + "-" + from;
        return (transformSpecs[toFrom] === undefined) ? <span class="branch-0 cbranch-no" title="branch not covered" >undefined </span>:
...
&nbsp;
        ...
        for (var i = 0; i &lt; transformSpecRoute.length - 1; i++) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (transformSpec === undefined) {
...
&nbsp;
            ...
            fluid.each(contexts, function (context, cname) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (context.preferences &amp;&amp; existingPrefs.contexts[cname] &amp;&amp; existingPrefs.contexts[cname].preferences) {
