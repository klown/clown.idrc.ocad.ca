...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-yes">609x</span>
<span class="cline-any cline-yes">609x</span>
...
<span class="cline-any cline-yes">1985x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    gpii.upgradeError = function (originError, whileMsg) {
        var error = originError instanceof Error ? originError : <span class="branch-1 cbranch-no" title="branch not covered" >fluid.extend({}, originError);</span>
...
<span class="cstat-no" title="statement not covered" >            failPromise.reject("No session was found when attempting keyout");</span>
...
&nbsp;
    gpii.lifecycleManager.processStart = function (that, finalPayload) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (that.sessionIndex[userToken]) {
            var failPromise = <span class="cstat-no" title="statement not covered" >fluid.promise();</span>
<span class="cstat-no" title="statement not covered" >            failPromise.reject("User already logged in when processing start item in queue. Aborting");</span>
<span class="cstat-no" title="statement not covered" >            return failPromise;</span>
        }
