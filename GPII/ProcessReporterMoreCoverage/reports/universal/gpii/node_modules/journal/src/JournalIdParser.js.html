...
<html lang="en">
<head>
    <title>Code coverage report for universal/gpii/node_modules/journal/src/JournalIdParser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">universal/gpii/node_modules/journal/src</a> JournalIdParser.js
    </h1>
    <div class='clearfix'>
...
gpii.journal.parseHeadId = function (journalId) {
    ...
    if (index.length &gt; 0) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (index.charAt(0) === "~") {
            var depthString = index.substring(1);
            depth = depthString.length === 0 ? 1 : fluid.parseInteger(depthString);
        } else {
<span class="cstat-no" title="statement not covered" >            return gpii.journal.idFormatError;</span>
        }
    } else {
        depth = 0;
    }
