...
<html lang="en">
<head>
    <title>Code coverage report for universal/gpii/node_modules/settingsHandlers/src/WebSocketsSettingsHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../../index.html">All files</a> / <a href="index.html">universal/gpii/node_modules/settingsHandlers/src</a> WebSocketsSettingsHandler.js
    </h1>
    <div class='clearfix'>
...
gpii.settingsHandlers.webSockets.addClient = function (that, solutionId, client) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!currentValue) {
...
&nbsp;
        if (oldValue === undefined) {
            type = "ADD";
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (value === undefined) {
            type = "DELETE";
        } else {
