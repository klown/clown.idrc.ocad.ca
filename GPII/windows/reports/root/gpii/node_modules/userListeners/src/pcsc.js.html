...
<html lang="en">
<head>
    <title>Code coverage report for root/gpii/node_modules/userListeners/src/pcsc.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\..\index.html">All files</a> / <a href="index.html">root/gpii/node_modules/userListeners/src</a> pcsc.js
    </h1>
    <div class='clearfix'>
...
gpii.windows.userListeners.getPCSCLite = function (that) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (gpii.windows.userListeners.isCardServiceRunning()) {
<span class="cstat-no" title="statement not covered" >        pcscLiteInstance = new Pcsclite();</span>
    } else {
...
gpii.windows.userListeners.windowMessagePCSC = function (that, hwnd, msg, wParam) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (msg === gpii.windows.API_constants.WM_DEVICECHANGE &amp;&amp;
<span class="branch-1 cbranch-no" title="branch not covered" >            wParam === gpii.windows.API_constants.DBT_DEVNODES_CHANGED)</span> {
        // A device has been added/removed - wait and see if the SCardSvr gets started.
<span class="cstat-no" title="statement not covered" >        gpii.windows.waitForCondition(gpii.windows.userListeners.isCardServiceRunning, {</span>
            timeout: 10000,
            pollDelay: 1000
        }).then(<span class="fstat-no" title="function not covered" >fu</span>nction () {
            // Service has started, start the listener.
<span class="cstat-no" title="statement not covered" >            if (that.active) {</span>
<span class="cstat-no" title="statement not covered" >                that.startListener();</span>
            }
<span class="cstat-no" title="statement not covered" >            that.stopMessages();</span>
        });
    }
};
&nbsp;</pre></td></tr>
