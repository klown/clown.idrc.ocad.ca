...
<html lang="en">
<head>
    <title>Code coverage report for root/gpii/node_modules/userListeners/src/proximity.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\..\index.html">All files</a> / <a href="index.html">root/gpii/node_modules/userListeners/src</a> proximity.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* Proximity listener - for the proximity device found on the Sony VAIO (and others).
 *
...
var fluid = require("gpii-universal"),
    path = require("path"),
    edge = process.versions.electron ? <span class="branch-0 cbranch-no" title="branch not covered" >require("electron-edge-js") </span>: require("edge-js");
&nbsp;
 ...
 * @param options.onTag {Function(tagBuffer)} [Optional] Call-back for when a tag has been presented.
 * @param options.stop {boolean} [Optional] true to stop listening for tags (onTag is ignored).
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!options || (typeof(options.gotTag) !== "function" &amp;&amp; !options.stop)) {
<span class="cstat-no" title="statement not covered" >        fluid.fail("listenForTags() expects either options.gotTag or options.stop to be defined.");</span>
    }
&nbsp;
 ...
 *
 * @param that {Component} The gpii.windows.userListeners.proximity instance.
 */
gpii.windows.userListeners.startProximityListener = function (that) {
    var promise = fluid.promise();
&nbsp;
    gpii.windows.userListeners.listenForTags({
        gotTag: <span class="fstat-no" title="function not covered" >fu</span>nction (tagBuffer) {
<span class="cstat-no" title="statement not covered" >            gpii.windows.userListeners.gotProximityTag(that, tagBuffer);</span>
        }
 ...
 *
 * @param that {Component} The gpii.windows.userListeners.proximity instance.
 * @param tagBuffer {Buffer} The NTAG message.
 */
gpii.windows.userListeners.gotProximityTag = <span class="fstat-no" title="function not covered" >fu</span>nction (that, tagBuffer) {
...
<span class="cstat-no" title="statement not covered" >        that.events.onTokenArrive.fire(that, text);</span>
    }
};
&nbsp;
/**
 ...
 *
 * @returns {Promise} Resolves when stopped (value true if there was a device).
 */
