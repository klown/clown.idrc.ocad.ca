...
<html lang="en">
<head>
    <title>Code coverage report for root/gpii/node_modules/userListeners/src/usb.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\..\index.html">All files</a> / <a href="index.html">root/gpii/node_modules/userListeners/src</a> usb.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (hdr.deviceType === windows.API_constants.DBT_DEVTYP_VOLUME) {
            var DBTF_NET = 0x2;
            var volume = new windows.DEV_BROADCAST_VOLUME(lParam.reinterpret(windows.DEV_BROADCAST_VOLUME.size));
&nbsp;
            // Only local drives.
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!(volume.flags &amp; DBTF_NET)) {
