...
<html lang="en">
<head>
    <title>Code coverage report for root/gpii/node_modules/windowMessages/src/windowMessages.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\..\index.html">All files</a> / <a href="index.html">root/gpii/node_modules/windowMessages/src</a> windowMessages.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* Captures Window messages.
 *
...
gpii.windows.messages.start = function (that, component) {
    var id = component.id;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (that.references.indexOf(id) === -1) {
...
&nbsp;
    var loop = function () {
        ...
        var msg = new Buffer(process.arch === "x64" ? <span class="branch-0 cbranch-no" title="branch not covered" >48 </span>: 28);
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (that.messageWindow) {
...
gpii.windows.messages.createMessageWindow = function (that) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (that.messageWindow) {
<span class="cstat-no" title="statement not covered" >        fluid.fail("Message window already created.");</span>
    }
&nbsp;
...
&nbsp;
        ...
        gpii.windows.messages.windowProcPointer = <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >            cls.lpfnWndProc();</span>
        };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            fluid.fail("RegisterClass failed");</span>
        }
    }
&nbsp;
    // Start the message loop
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!process.versions.electron) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!that.messageWindow) {
<span class="cstat-no" title="statement not covered" >        fluid.fail("CreateWindowEx failed");</span>
    }
};
&nbsp;
/**
