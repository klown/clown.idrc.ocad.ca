...
<html lang="en">
<head>
    <title>Code coverage report for root/gpii/node_modules/processHandling/processHandling.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\..\..\index.html">All files</a> / <a href="index.html">root/gpii/node_modules/processHandling</a> processHandling.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>43/64</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-yes">131x</span>
<span class="cline-any cline-yes">131x</span>
<span class="cline-any cline-yes">9825x</span>
<span class="cline-any cline-yes">9825x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9825x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9779x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">131x</span>
...
gpii.windows.killProcessByName = function (filename) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (pids) {
        for (var n = 0, len = pids.length; n &lt; len; n++) {
            var hProcess = windows.kernel32.OpenProcess(c.PROCESS_TERMINATE, 0, pids[n]);
            <span class="missing-if-branch" title="else path not taken" >E</span>if (hProcess !== ref.NULL) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hSnapShot === windows.API_constants.INVALID_HANDLE_VALUE) {
<span class="cstat-no" title="statement not covered" >        console.error("CreateToolhelp32Snapshot failed. Win32 error: " + windows.GetLastError());</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (hSnapShot) {
...
&nbsp;
    var pids = gpii.windows.findProcessByName(filename, true);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!pids) {
        // Process is not running.
<span class="cstat-no" title="statement not covered" >        return fluid.toPromise(true);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                if (options.cleanOnly) {</span>
<span class="cstat-no" title="statement not covered" >                    promiseTogo.reject({</span>
                        isError: true,
...
<span class="cstat-no" title="statement not covered" >                    gpii.windows.killProcessByName(filename);</span>
&nbsp;
                    // This promise was rejected but the return promise should resolve as the process is terminated.
<span class="cstat-no" title="statement not covered" >                    promiseTogo.resolve(false);</span>
                }
            });
    } else {
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (pid) {
        hProcess =
            gpii.windows.kernel32.OpenProcess(gpii.windows.API_constants.PROCESS_QUERY_LIMITED_INFORMATION, 0, pid);
    } else {
<span class="cstat-no" title="statement not covered" >        fluid.fail("Either pid or processHandle needs to be given.");</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (hProcess) {
        try {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!togo) {
        ...
        var all = <span class="cstat-no" title="statement not covered" >gpii.windows.findProcessByName(null, true, true);</span>
        var process = <span class="cstat-no" title="statement not covered" >all.find(<span class="fstat-no" title="function not covered" >fu</span>nction (p) {</span>
<span class="cstat-no" title="statement not covered" >            return p.pid === pid;</span>
        });
<span class="cstat-no" title="statement not covered" >        if (process) {</span>
<span class="cstat-no" title="statement not covered" >            togo = process.exeFile;</span>
        }
    }
    return togo;
&nbsp;
...
&nbsp;
    var serviceHandle;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (managerHandle) {
...
&nbsp;
    var state;
    switch (stateNumber) {
<span class="branch-0 cbranch-no" title="branch not covered" >    case gpii.windows.API_constants.SERVICE_PAUSE_PENDING:</span>
<span class="branch-1 cbranch-no" title="branch not covered" >    case gpii.windows.API_constants.SERVICE_PAUSED:</span>
<span class="cstat-no" title="statement not covered" >        state = "paused";</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
<span class="branch-2 cbranch-no" title="branch not covered" >    case gpii.windows.API_constants.SERVICE_CONTINUE_PENDING:</span>
<span class="branch-3 cbranch-no" title="branch not covered" >    case gpii.windows.API_constants.SERVICE_START_PENDING:</span>
    case gpii.windows.API_constants.SERVICE_RUNNING:
        state = "running";
        break;
<span class="branch-5 cbranch-no" title="branch not covered" >    case gpii.windows.API_constants.SERVICE_STOP_PENDING:</span>
